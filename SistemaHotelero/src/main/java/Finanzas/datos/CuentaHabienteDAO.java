...
public class CuentaHabienteDAO {
      private static final String sql_select = "SELECT Codigo_CuentaHabiente, Nombre_CuentaHabiente, ApellidoP_CuentaHabiente,ApellidoM_CuentaHabiente,TipoPersona_CuentaHabiente,Saldo_Disponible FROM CuentaHabiente";
    private static final String sql_insert = "INSERT INTO CuentaHabiente(Codigo_CuentaHabiente, Nombre_CuentaHabiente, ApellidoP_CuentaHabiente,ApellidoM_CuentaHabiente,TipoPersona_CuentaHabiente,Saldo_Disponible) VALUES(?,?,?,?,?,?)";
    private static final String SQL_UPDATE = "UPDATE CuentaHabiente SET Codigo_CuentaHabiente=?, Nombre_CuentaHabiente=?, ApellidoP_CuentaHabiente=?,ApellidoM_CuentaHabiente=? ,Saldo_Disponible=? WHERE Codigo_CuentaHabiente = ?";
    private static final String sql_delete = "DELETE FROM CuentaHabiente WHERE Codigo_CuentaHabiente=?";
    private static final String sql_query = "SELECT Codigo_CuentaHabiente, Nombre_CuentaHabiente, ApellidoP_CuentaHabiente,ApellidoM_CuentaHabiente,TipoPersona_CuentaHabiente,Saldo_Disponible FROM CuentaHabiente WHERE Codigo_CuentaHabiente=?";
            ...
            while (rs.next()) {
               String Codigo_CuentaHabiente = rs.getString("Codigo_CuentaHabiente");
                ...
                String TipoPersona_CuentaHabiente = rs.getString("TipoPersona_CuentaHabiente");
                    String Saldo_Disponible = rs.getString("Saldo_Disponible");    
               ...
               cuenta.setCodigo_CuentaHabiente(Codigo_CuentaHabiente);
                ...
                cuenta.setSaldo_Disponible(Saldo_Disponible);
    ...
    public int insert(CuentaHabiente cuenta) {
        ...
        try {
            ...
            stmt.setString(6, cuenta.getSaldo_Disponible());
